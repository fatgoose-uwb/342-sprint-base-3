...
// Dispatch helper class for using btree::internal_locate with compare-to.
    ...
    private:
        ...
        node_type *new_internal_node(node_type *parent) {
            ...
            internal_fields *p = reinterpret_cast<internal_fields *>(internal_allocator_traits::allocate(ia,
        ...
        node_type *new_internal_root_node() {
            internal_allocator_type &ia = __internal_allocator();
            root_fields *p = reinterpret_cast<root_fields *>(internal_allocator_traits::allocate(ia,
                                                                                                 sizeof(root_fields)));
        ...
        node_type *new_leaf_node(node_type *parent) {
            internal_allocator_type &ia = __internal_allocator();
            leaf_fields *p = reinterpret_cast<leaf_fields *>(internal_allocator_traits::allocate(ia,
                                                                                                 sizeof(leaf_fields)));
