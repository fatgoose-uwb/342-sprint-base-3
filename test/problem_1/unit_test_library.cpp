...
/*
 * TODO: A line is missing in this function, and it will cause the test to fail even if the code is correct.
 *  Fix this by adding the missing line with a comment explaining what's the issue and why the fix.
 */
TEST(problem_1, library) {
    ...
    /*
     * need to return the Frankenstein book (this is what's missing)
     */
