...
void traverse_in_order_test_cases_int(std::vector<TraverseTestCase<int>> &test_cases) {
    ...
    test_cases.push_back(TraverseTestCase<int>(root, {2, 1}));
    ...
    root->left = new TreeNode(2);
    root->right = new TreeNode(3);
    test_cases.push_back(TraverseTestCase<int>(root, {2, 1, 3}));
    ...
    test_cases.push_back(TraverseTestCase<int>(root, {3, 2, 1}));
    ...
    test_cases.push_back(TraverseTestCase<int>(root, {4, 2, 5, 1, 3, 6}));
    ...
    root->right = new TreeNode(3);
    root->right->right = new TreeNode(6);
    test_cases.push_back(TraverseTestCase<int>(root, {9, 7, 4, 2, 8, 5, 1, 3, 6}));
}