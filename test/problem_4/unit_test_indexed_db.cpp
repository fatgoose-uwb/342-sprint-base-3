...
TEST(problem_4, test_db_initialization) {
...
TEST(problem_4, db_insert_first_record) {
...
TEST(problem_4, test_db_multiple_records_search_by_id) {
...
TEST(problem_4, test_db_multiple_records_search_by_age) {
...
TEST(problem_4, test_db_multiple_records_search_by_name) {
...
TEST(problem_4, db_multiple_records_search_by_hobbies_single_answer) {
...
TEST(problem_4, db_multiple_records_search_by_hobbies_multiple_answer) {
...
TEST(problem_4, test_db_multiple_records_search_by_hobbies_no_partial_match) {
...
TEST(problem_4, test_db_multiple_records_search_by_age_range) {
    /*
